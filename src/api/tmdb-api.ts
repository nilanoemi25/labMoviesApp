export const getMovies = () => {
  return fetch(
    `https://api.themoviedb.org/3/discover/movie?api_key=cf899fb1da2f1175a57f4bf7d19f2929&language=en-US&include_adult=false&include_video=false&page=1`
  ).then((response) => {
    if (!response.ok)
 ...
 export const getMovie = (id: string) => {
  ...
  return fetch(
    "https://api.themoviedb.org/3/genre/movie/list?api_key=cf899fb1da2f1175a57f4bf7d19f2929&language=en-US"
  ).then( (response) => {
    if (!response.ok)
